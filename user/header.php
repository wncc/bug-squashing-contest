<div class="row" style="margin-top: 10px; margin-bottom:10px;">
	<div class="span4" >
		<img src='../bug-squasher.png' width=250 />
	</div>	            
	<div class="span8" style="margin-top: 30px;">
		<ul class="nav nav-pills pull-right">
		<li <?php if ($menukey=='home.php') echo 'class="active"'; ?>><a href="home.php" data-toggle="pill" rel="tab"><h3>Home</h3></a></li>                     
		...
		"<form method = 'get' action='https://accounts.google.com/o/oauth2/auth' style='float:right;'>".                
			...
			"<input type='hidden'name='redirect_uri' value='http://wncc.stab-iitb.org/bug-squashing-contest/user/profile.php'>".
		...
		echo 
		"<li><form method='GET' action='profile.php' class='span2'><input type='hidden' name='logout' value='true' />".                
